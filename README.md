...
Due to data use restrictions, the MIMIC-IV-Note dataset (v2.2) cannot be publicly shared in this repository. However, it is available to credentialed users via PhysioNet (https://physionet.org/content/mimic-iv-note/2.2/) upon completion of the required data use agreement and approval process.
